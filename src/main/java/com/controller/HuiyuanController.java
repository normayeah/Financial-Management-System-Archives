...
public class HuiyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		HuiyuanEntity user = huiyuanService.selectOne(new EntityWrapper<HuiyuanEntity>().eq("nicheng", username));
    ...
    public R register(@RequestBody HuiyuanEntity huiyuan){
    	...
    	HuiyuanEntity user = huiyuanService.selectOne(new EntityWrapper<HuiyuanEntity>().eq("nicheng", huiyuan.getNicheng()));
		if(user!=null) {
